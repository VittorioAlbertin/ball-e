...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/install/msgs_interfaces"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/msgs_interfaces/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/msgs_interfaces/environment/path.sh"
