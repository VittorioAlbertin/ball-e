#!/usr/bin/env python3
"""
Launch file for Ball-e home room simulation with Gazebo Classic.

This launch file starts:
1. Gazebo Classic with the home_room world
...
def generate_launch_description():
    ...
    world_file = os.path.join(ball_e_gazebo_dir, 'worlds', 'home_room.world')
